<aside class="sidebar">
    ...
    <div class="sidebar-header">
        ...
        <div class="sidebar-school-info">
            ...
            <p class="school-sub">Registrar Access</p>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('registrar_dashboard') }}" 
           class="nav-item {{ request()->routeIs('registrar_dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('registrar.applications') }}" 
           class="nav-item {{ request()->routeIs('registrar.applications') ? 'active' : '' }}">           
        ...
        <a href="{{ route('registrar.documents') }}" 
           class="nav-item {{ request()->routeIs('registrar.documents') ? 'active' : '' }}">
        ...
        {{-- Student Records --}}
        <a href="{{ route('registrar.student_records') }}" class="nav-item {{ request()->routeIs('registrar.student_records') ? 'active' : '' }}">
        ...
        {{-- My Profile --}}
        <a href="{{ route('registrar.profile') }}" class="nav-item {{ request()->routeIs('registrar.profile') ? 'active' : '' }}">
        ...
        <a href="{{ route('registrar.password.show') }}" 
           class="nav-item {{ request()->routeIs('registrar.password.show') ? 'active' : '' }}">
