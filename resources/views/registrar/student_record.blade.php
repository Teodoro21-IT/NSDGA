        ...
        <div class="p-10 pt-24 w-full max-w-7xl mx-auto">
            <div class="flex justify-between items-end mb-10">
                ...
                <div class="relative w-96">
                    <input type="text" placeholder="Search by LRN or Name..." 
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50/30 transition-colors group">
                            ...
                            <td class="px-8 py-6">
                                <span class="font-mono text-xs font-bold text-slate-500">{{ $student->lrn ?? '136676090147' }}</span>
                            </td>
                            <td class="px-8 py-6">
                            ...
                            <td class="px-8 py-6">
                                <span class="px-3 py-1 bg-green-100 text-green-600 text-[9px] font-black rounded-full uppercase tracking-wider">Officially Enrolled</span>
                            </td>
                            <td class="px-8 py-6 text-right">
                                {{-- Updated Action Link to point to the View page --}}
