...
<body class="bg-[#F3F4F6] min-h-screen text-slate-800">
        ...
        <div class="p-8 space-y-8">
            ...
            <div class="max-w-4xl">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button class="text-sm font-medium text-indigo-600 hover:text-indigo-700 transition">View All Applications</button>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div onclick="openModal('Juan Dela Cruz', 'juan.dc@email.com', 'BS Information Technology', '2026-0042')" 
                         class="bg-white p-5 rounded-xl border border-gray-100 hover:border-indigo-500 hover:shadow-md transition-all cursor-pointer group">
                        <div class="flex justify-between items-start">
                            <div>
                                <h4 class="font-bold text-gray-900 group-hover:text-indigo-600 transition">Juan Dela Cruz</h4>
                                <p class="text-xs text-gray-500 mt-1">BS Information Technology</p>
                            </div>
                            <span class="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-full uppercase tracking-wider">Review Details</span>
                        </div>
                    </div>
                    ...
                    <div onclick="openModal('Maria Santos', 'maria.s@email.com', 'BS Computer Science', '2026-0043')" 
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                <h4 class="font-bold text-gray-900 group-hover:text-indigo-600 transition">Maria Santos</h4>
                                <p class="text-xs text-gray-500 mt-1">BS Computer Science</p>
                            </div>
                            <span class="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-full uppercase tracking-wider">Review Details</span>
                        </div>
                    </div>
    ...
    <div id="reviewModal" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-slate-900/40 backdrop-blur-sm transition-opacity duration-300">
            ...
            <div class="p-8 space-y-6">
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <p id="modalName" class="text-sm font-semibold text-gray-900 mt-1"></p>
                    </div>
                    <div>
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Student ID</p>
                        <p id="modalID" class="text-sm font-semibold text-gray-900 mt-1"></p>
                    </div>
                    <div>
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Email Address</p>
                        <p id="modalEmail" class="text-sm font-semibold text-gray-900 mt-1"></p>
                    </div>
                    <div>
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Course</p>
                        <p id="modalCourse" class="text-sm font-semibold text-gray-900 mt-1"></p>
                    </div>
                </div>
            </div>
